...
void setup() {
  ...
  //Set up pins to communicate with GPS
  int rxPin = 19;                    // RX PIN
  int txPin = 18;                    // TX TX 

  //Change frequency of PWM on Pin 9 (see http://arduino.cc/forum/index.php?topic=72092.0)
  int myEraser = 7;            
  TCCR2B &= ~myEraser;         
  int myPrescaler = 1;         
  TCCR2B |= myPrescaler;  

  //Set up pin to enable radio, PWM pin, and GPS comms
